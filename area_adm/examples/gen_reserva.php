...
<head>
    ...
    <title>AgenSf - Gerenciar Reservas</title>
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <a class="navbar-brand"> Gerenciar Reservas </a>
            ...
            <section class="p-5">
                <h3 class="text-center mb-3">Lista de Reservas</h3>
                <div class="row mb-3">
                    ...
                    if (isset($_GET['search']) && !empty($_GET['search'])) {
                        ...
                        $sql_busc = "SELECT * FROM reserva WHERE LOWER(descricao) LIKE LOWER('%$nome_busc%')";
                    ...
                    ?>
                        ...
                        <div class="col pt-3">
                            <h5 class="text-end">Número de Reservas: <strong><?php echo $cont_user; ?></strong></h5>
                        </div>
                </div>
                <table class="table">
                    <thead class="table-title table-dark border border-dark">
                        ...
                        <th class=""><strong>Início</strong></th>
                        <th class=""><strong>Termino</strong></th>
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($result_busc) > 0) {
                            ...
                            while ($row_busc = mysqli_fetch_assoc($result_busc)) {
                                ...
                                $b = $row_busc['IdUsuario'];
                                $a = "SELECT * FROM usuario WHERE idUSUARIO = '$b'";
                                $resultado2 = mysqli_query($conecta, $a);
                                $linha2 = mysqli_fetch_assoc($resultado2);
                        ?>
                                <tr class="table-success">
                                    <td class="text-capitalize"><?php echo $row_busc['descricao']; ?></td>
                                    <td class='text-capitalize'><?php echo $linha2['nome']; ?></td>
                                    <td><?php echo $row_busc['data_inicio']; ?></td>
                                    <td><?php echo $row_busc['data_fim']; ?></td>
                                    <td>
                                        <button onclick="AlertReserva(<?php echo $row_busc['idRESERVA']; ?>)" class="btn border-2 border border-dark"><i class="bi bi-trash3-fill"></i></button>
                                    </td>
                                </tr>
                        <?php
                            }
                        } else {
                            echo "<tr ><td colspan='5' class='text-center text-danger'><strong>Nenhuma reserva encontrada.</strong></td></tr>";
                        }
...
?>
    ...
    <script>
        Swal.fire({
            ...
            window.location.href = "gen_reserva.php";
    ...
    function AlertReserva(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `../../delet_reserva.php?id=${id}`;
            }
        });
    }
</script>
